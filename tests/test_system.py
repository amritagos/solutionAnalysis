...
def simple_system():
    ...
    system.push_back(solu.solvlib.Atom(2, 2, 1, [33.608039, 32.001989, 48.014306])) # H1
    system.push_back(solu.solvlib.Atom(3, 2, 1, [32.880148, 30.854267, 48.195911])) # H2
    system.push_back(solu.solvlib.Atom(4, 1, 2, [37.219210, 42.159763, 29.721422])) # O
    system.push_back(solu.solvlib.Atom(5, 2, 2, [36.836746, 41.424653, 29.994215])) # H1
    system.push_back(solu.solvlib.Atom(6, 2, 2, [36.614956, 42.771812, 29.867550])) # H2
